...
if __name__ == "__main__":
    ...
    # name of the test and bearing number for feature calculation 
    test_name = '1st_test'
    bearing_number = 4
    ...
    # training data distance calculation 
    ...
    # # testing data distance calculation
    ...
    # # plot the machiune health status 
